...
use optimistic_oracle::contracts::{common::address_whitelist::address_whitelist,interfaces::{IAddressWhitelistDispatcher, IAddressWhitelistDispatcherTrait}};
...
fn test_address_whitelist_add_to_whitelist(){
    ...
    // Duplicate insertion
    address_whitelist.add_to_whitelist(address_to_add);
    assert(address_whitelist.get_whitelist() == expected_result.span(), 'AW: Duplicate insertion failed');
    assert_eq!(address_whitelist.is_on_whitelist(address_to_add), true); 
