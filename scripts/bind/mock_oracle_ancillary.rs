...
impl TryFrom<starknet::core::types::EmittedEvent> for Event {
    ...
    fn try_from(
                ...
                })
        {
            ...
            let request_id = match starknet::core::types::FieldElement::cairo_deserialize(
                &event.data,
                data_offset,
            ) {
                Ok(v) => v,
...
impl<A: starknet::accounts::ConnectedAccount + Sync> mock_oracle_ancillary<A> {
    ...
    pub fn get_request_parameters(
        &self,
        request_id: &starknet::core::types::FieldElement,
    ) -> cainome::cairo_serde::call::FCall<A::Provider, QueryPoint> {
        use cainome::cairo_serde::CairoSerde;
        let mut __calldata = vec![];
        __calldata
            .extend(starknet::core::types::FieldElement::cairo_serialize(request_id));
        let __call = starknet::core::types::FunctionCall {
            contract_address: self.address,
